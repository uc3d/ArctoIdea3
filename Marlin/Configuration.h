...
#define STRING_CONFIG_H_AUTHOR "(UC3D, ArctoIdea3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UC3D ArctoIdea3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "e8b5fe85-d9b7-492e-a5a7-098c4fde6187"
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 24, 240 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.600 }
...
#define Z_PROBE_FEEDRATE_FAST (26*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST * 0.9)
...
#define FIL_RUNOUT_PIN       P1_28      // X-max pin
...
#define NEOPIXEL_LED
  ...
  // Sanity Checks and PIN in board definition
  // will have to be modified for this to compile correctly.
